# yoajung 요아정 P0 원문 대조 기록

## 입력 상태

- disclosureReferenceYear: 2024
- disclosureSourceUrl: FTC_ORIGINAL_DISCLOSURE_URL_REQUIRED
- crossCheckSourceUrl: https://fair.gg.go.kr/fran/search/unifiedSearchBrandInteg.do?brandYear=2024&frnchsNo=20220572
...
- averageAnnualSalesM: 623.918
- salesPerAreaM: 52.842
- currentStores: 372
- directStores: 2
- storeChange3y: 372
- openings3y: 368
...
- terminations3y: 0
- expirations3y: 1
- ownershipTransfers3y: 8

## P0 지표별 원문 대조 체크

| P0 지표 | 현재 후보값/원자료 | FTC 원문 확인 | 2차 출처 교차확인 | 검토 메모 |
| --- | --- | --- | --- | --- |
| 초기비용 | franchiseFee=5500천원, trainingFee=3300천원, deposit=6000천원, otherStartup=38500천원, startupTotal=53300천원 | [ ] | [x] | 천원 / 1000 = 백만원. FTC 원문 대조 필요. |
| 가맹점 수 추이 | currentStores=372, directStores=2, openings3y=368, storeChange3y=372 | [ ] | [x] | FTC 원문 대조 필요. |
| 평균매출 | averageAnnualSales=623918천원, salesPerArea=52842천원 | [ ] | [x] | 천원 / 1000 = 백만원. FTC 원문 대조 필요. |
| 폐점/계약해지 지표 | contractEnds3y=1, terminations3y=0, ownershipTransfers3y=8 | [ ] | [x] | closures3y는 계약종료+계약해지 대리값. FTC 원문 대조 필요. |
...
| 정보공개서 기준연도/출처 | referenceYear=2024, crossCheckSource=https://fair.gg.go.kr/fran/search/unifiedSearchBrandInteg.do?brandYear=2024&frnchsNo=20220572 | [ ] | [x] | FTC 원문 URL 필수. |
