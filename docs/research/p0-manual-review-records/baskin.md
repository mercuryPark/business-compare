# baskin 베스킨라빈스 P0 원문 대조 기록

## 입력 상태

- disclosureReferenceYear: 2024
- disclosureSourceUrl: FTC_ORIGINAL_DISCLOSURE_URL_REQUIRED
- crossCheckSourceUrl: https://fair.gg.go.kr/fran/search/unifiedSearchBrandInteg.do?brandYear=2024&frnchsNo=20080500015
...
- averageAnnualSalesM: 526.025
- salesPerAreaM: 24.989
- currentStores: 1706
- directStores: 41
- storeChange3y: 19
- openings3y: 91
...
- terminations3y: 33
- expirations3y: 5
- ownershipTransfers3y: 170

## P0 지표별 원문 대조 체크

| P0 지표 | 현재 후보값/원자료 | FTC 원문 확인 | 2차 출처 교차확인 | 검토 메모 |
| --- | --- | --- | --- | --- |
| 초기비용 | franchiseFee=8800천원, trainingFee=1650천원, deposit=40000천원, otherStartup=228500천원, startupTotal=278950천원 | [ ] | [x] | 천원 / 1000 = 백만원. FTC 원문 대조 필요. |
| 가맹점 수 추이 | currentStores=1706, directStores=41, openings3y=91, storeChange3y=19 | [ ] | [x] | FTC 원문 대조 필요. |
| 평균매출 | averageAnnualSales=526025천원, salesPerArea=24989천원 | [ ] | [x] | 천원 / 1000 = 백만원. FTC 원문 대조 필요. |
| 폐점/계약해지 지표 | contractEnds3y=5, terminations3y=33, ownershipTransfers3y=170 | [ ] | [x] | closures3y는 계약종료+계약해지 대리값. FTC 원문 대조 필요. |
...
| 정보공개서 기준연도/출처 | referenceYear=2024, crossCheckSource=https://fair.gg.go.kr/fran/search/unifiedSearchBrandInteg.do?brandYear=2024&frnchsNo=20080500015 | [ ] | [x] | FTC 원문 URL 필수. |
