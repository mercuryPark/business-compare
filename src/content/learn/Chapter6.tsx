    ...
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-muted">
          ...
          빠뜨리지 않고 챙기는 기본기를 정리합니다. 마지막 월 운영 체크리스트는 매달 한 번씩
          다시 펴 보세요.
        </p>
      </header>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink">
          계산의 핵심은 한 그릇·한 잔을 팔 때마다 남는 돈으로 고정비를 메우는 구조입니다.
          매출에서 <span className="font-semibold">변동비(팔린 만큼 늘어나는 원재료·수수료)</span>를
          빼면 한 번 팔 때 남는 돈이 나옵니다. 이 돈으로{' '}
          <span className="font-semibold">고정비(매출이 0이어도 나가는 임대료·인건비·대출이자)</span>를
          다 메우는 매출이 손익분기점이고, 그 위부터가 이익입니다.
        </p>
        <Callout tone="info">
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-line bg-surface p-4">
            ...
            <p className="text-sm text-ink">
              ...
              />
              는 정규직뿐 아니라 단기 아르바이트에게도 작성해서 한 부를 내주어야 합니다. 작성·교부를
              하지 않으면 그 자체로 과태료 대상입니다. 시급, 근무 요일·시간, 주휴 여부, 수습 적용
              여부를 명확히 적으세요.
            </p>
          </div>
          <div className="rounded-xl border border-line bg-surface p-4">
        ...
        <NumericClaim
          label="주휴수당 발생 기준"
          value="4주 평균 1주 소정근로 15시간 이상 + 그 주 개근"
          basis="기준 — 4주를 평균하여 1주 소정근로시간이 15시간 이상이고 그 주의 소정근로일을 개근하면 주휴수당이 발생. 구체 요건·계산은 고용노동부 안내·노무사 확인 필요"
          sourceId={LABOR_ID}
        />
        <p className="text-sm text-ink">
          <TermExplainer
            term="주휴수당"
            explanation="4주를 평균하여 1주 소정근로시간이 15시간 이상이고 그 주의 소정근로일을 개근하면, 유급으로 쉬는 하루치 임금을 추가로 지급해야 하는 제도."
          />
          은 초보 사장님이 가장 자주 빠뜨리는 인건비입니다. 4주 평균 주 15시간 이상 일하고 그 주를
          개근한 직원에게는 실제 일한 시간 외에 하루치 임금이 더 나갑니다. 이 몫을 인건비 계산에
          처음부터 넣어두세요. 빠뜨리면 나중에 체불로 한꺼번에 청구될 수 있습니다.
        </p>
