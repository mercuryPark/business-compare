    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink">
          ...
          />
          은 초보 사장님이 가장 자주 빠뜨리는 인건비입니다. &lsquo;4주 평균 주 15시간 이상 일하고
          그 주를 개근한 직원에게는 실제 일한 시간 외에 하루치 임금이 더 나간다&rsquo;는 점을 인건비
          계산에 처음부터 넣어두어야 합니다. 빠뜨리면 나중에 체불로 한꺼번에 청구될 수 있습니다.
        </p>
