      ...
      <section className="space-y-3">
        ...
        <CashflowCalendar
          ...
          entries={[
            ...
            { month: '4월·10월', item: '개인 일반과세자 부가세 예정고지 납부(대상자에 한해, 고지서가 온 경우 — 직전 납부세액의 1/2)' },
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <NumericClaim
            label="부가세 신고·납부 시기"
            value="법인 연 4회 / 개인 일반 연 2회(+예정고지) / 간이 연 1회"
            basis="개인 일반은 확정신고 연 2회에 예정고지가 더해질 수 있고, 간이도 예외가 있음 — 국세청 자료·세무사 확인 필요"
            sourceId={VAT_ID}
          />
          <NumericClaim
            label="종합소득세 정산"
