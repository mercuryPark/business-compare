    ...
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-muted">
          창업 비용은 &lsquo;인테리어 얼마, 보증금 얼마&rsquo; 식으로 따로따로 떠오르지만, 통장에서는
          한꺼번에 빠져나갑니다. 이 장은 시작할 때 드는 돈을 항목별로 한 지도에 펼쳐 봅니다. 그리고
          사람들이 자주 빠뜨리는 비용과{' '}
          <span className="font-semibold">&lsquo;잘 안 됐을 때 잃는 돈&rsquo;</span>까지 따져봅니다.
        </p>
      </header>

      <Caveat>
        이 장의 금액은 모두 <span className="font-semibold">예시 범위·예시 가정</span>이며, 공식
        통계가 아닙니다. 실제 비용은 입지·업종·면적·브랜드에 따라 크게 차이가 납니다. 숫자 자체보다
        &lsquo;어떤 항목이 있는지, 무엇을 빠뜨리기 쉬운지&rsquo;를 보는 데 쓰세요.
      </Caveat>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink">
          ...
          <span className="font-semibold">예시 범위</span>일 뿐, 내 가게의 견적이 아닙니다. 금액보다
          각 항목이 &lsquo;나에게도 발생하는지&rsquo;를 먼저 체크하세요.
        </p>
        <SourceBackedTable
        ...
        <p className="text-sm text-ink">
          핵심은 마지막 줄입니다.{' '}
          <span className="font-semibold">예비 운전자금은 초기비용에 포함된 돈이 아니라, 그와는
          별도로 떼어 두어야 하는 돈</span>입니다(1장 참고). 초기 투자에 가진 돈을 다 쓰고 예비자금이
          바닥이면, 첫 고비에서 버티지 못합니다.
        </p>
      </section>
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-line bg-surface p-4">
            ...
            <p className="text-sm text-ink">
              ...
              돌려받을 수 있을 것 같지만,{' '}
              <span className="font-semibold">상권이 죽거나 임대인이 직접 쓰겠다고 하면 한 푼도
              회수하지 못할 수 있습니다.</span> 그래서 권리금은 &lsquo;자산&rsquo;이 아니라
              &lsquo;잃을 수도 있는 돈&rsquo;으로 보고 계산해야 합니다.
            </p>
          </div>
          <div className="rounded-xl border border-line bg-surface p-4">
            ...
            <p className="text-sm text-ink">
              ...
              그대로 손실이 되니, 첫 발주량은 보수적으로 잡는 것이 안전합니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink">
          ...
          비용들입니다. 따로 보면 작아 보여도, 모이면 초기 예산을 크게 넘기게 만듭니다.
        </p>
        <HiddenCostList
          items={[
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink">
          ...
          괜찮은가?&rdquo;</span> &mdash; 에 답할 차례입니다. 가게를 닫을 때는 그동안 쓴 돈만
          사라지는 게 아닙니다. <span className="font-semibold">닫기 위해 추가로 드는 돈</span>이
          또 있습니다. 아래는 작은 매장 기준의 예시 가정이며, 실제 손실 규모는 계약 조건과 잔여
          기간에 따라 크게 달라집니다.
        </p>
        <SourceBackedTable
        ...
        <p className="text-sm text-ink">
          이 표의 핵심 메시지는 하나입니다.{' '}
          <span className="font-semibold">폐업은 본전으로 돌아가는 게 아니라 마이너스에서
          시작합니다.</span> 보증금처럼 일부 돌려받는 돈도 있습니다. 하지만 권리금·인테리어·초도물품은
      ...
      <section className="space-y-3 rounded-xl border border-line bg-mist/40 p-4">
        ...
        <p className="text-sm text-ink">
          초기비용은 한 번 내는 돈입니다. 하지만 가게를 살리고 죽이는 건 매달 반복되는 돈의
          흐름입니다. 다음 장에서는 고정비·변동비·숨은 비용을 정리하고, 월매출이 손에 남는 돈으로
          바뀌는 과정을 워터폴과 시나리오로 따라가 봅니다.
        </p>
